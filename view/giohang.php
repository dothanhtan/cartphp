...
<div class="container-fluid">
	<?php if(Cart::GetCart() == null) {?>
		<div class="product-null">
			...
			<a href="view/trangchu.php" class="continue-buy-item">Shopping</a>
		</div>
    <?php }else{ ?> 
	...
	<?php foreach ($lsCart as $key => $value){?>
        <div class="cart-item-product">
            ...
            <div class="item-product">
                <img src="<?php echo $value->product->image ?>" alt="" />
                <p><?php echo $value->product->nameproduct ?> </p>
            </div>
            ...
            <button class="btn btn-outline-danger text-warning item-action"><i class="fa fa-trash-alt text-warning"></i> Delete</button> 
        </div>
    <?php } ?>
    <div class="cart-page-product-footer">
        <a class="btn btn-primary" href="trangchu">Tiếp tục mua hàng</a>
        ...
        <button class="ml-5 cart-buy-items">Thanh toán</button>
    </div>
	 <?php } ?>
</div> <!-- container .//  -->
</section>

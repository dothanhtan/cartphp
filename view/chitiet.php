			...
			<div class="info-main">
                ...
                <div class="info-aside">
                    <div class="price-wrap">
                        <span class="price h5"><?php echo $product->price ?>₫ </span>	
                    </div> <!-- info-price-detail // -->
                    <p class="text-success">Miễn phí ship</p>
                    <br>
                    <p>
                        <a href="giohang.php" class="btn btn-primary btn-block"> Mua ngay </a>
	...
	<div class="container">
		...
		<section class="footer-bottom border-top row">
			...
			<div class="col-md-8 text-md-center">
				<span  class="px-2">thanhtan280198@gmail.com</span>

...
<body>
    <div class="wrapper">
        ...
        <section class='container' id='slider'>
            <div class="row">
                <div class="col-sm-3">
                <button type="button" class="btn btn-block btn-warning text-light font-weight-bold" data-toggle="collapse" data-target="#demo">DANH MỤC SẢN PHẨM</button>
        ...
        <section class="container">
            <table class="table table-bordered table-hover mb-5">
                ...
                <tbody>
                    <tr class="align-middle text-center">
                        <td><img src="../images/sanpham1_1.jpg" alt="Sanpham1" width="64px"></td>
                        <td class="align-middle">Máy lọc nước Kangaroo Hydrogen KG100HC vỏ tủ VTU</td>
                        <td class="align-middle">8.290.000₫</td>
                        <td class="align-middle"><input type="number" name="txtnum"></td>
                        <td class="align-middle">8.290.000₫</td>
                        <td class="align-middle"><button class="btn btn-outline-danger"><i class="far fa-trash-alt"></i> Delete</button></td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
                        <th colspan="5">Tổng cộng</th>
                        <th class="text-success">8.290.000₫</th>
                    </tr>
                </tfoot>
            </table>
            
            <a href="home.php" class="btn btn-success mb-4">MUA TIẾP</a>
            <a href="#" class="btn btn-danger float-right mb-4">THANH TOÁN</a>

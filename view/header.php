...
<link href="../images/logodmx.png" rel="icon" type="image/png" sizes="16x16">
...
<div class="row align-items-center">
	...
	<div class="col-lg-6 col-sm-12">
		<form action="trangchu" class="search">
	...
	<div class="col-lg-4 col-sm-6 col-12">
		<div class="widgets-wrap float-md-right">
			<div class="widget-header  mr-3">
				<a href="giohang.php" class="icon icon-sm rounded-circle border"><i class="fa fa-shopping-cart"></i></a>
				<span class="badge badge-pill badge-danger notify">0</span>
			</div>
			<div class="widget-header icontext">
				<a href="#" class="icon icon-sm rounded-circle border"><i class="fa fa-user"></i></a>
				<div class="text">
					<span class="text-muted">Xin chào Tân!</span>
					<div> 
						<a href="#">Đăng nhập</a> |  
						<a href="#"> Đăng ký</a>
					</div>
